...
class DionysusTestbedTopo(Topo):
    ...
    def __init__(self):
        ...
        self.addLink('h4', 's4', port1=1, port2=5, **host_link_config)
        self.addLink('h5', 's5', port1=1, port2=5, **host_link_config)
        self.addLink('h6', 's6', port1=1, port2=4, **host_link_config)
        self.addLink('h7', 's7', port1=1, port2=5, **host_link_config)
        self.addLink('h8', 's8', port1=1, port2=5, **host_link_config)
